...
//                      color: Colors.red,
          ...
          children: <Widget>[
            Container(
//                            margin: const EdgeInsets.only(top: 10.0),
              padding: EdgeInsets.fromLTRB(3, 5, 10, 5),
...
//                  Navigator.of(context).pushNamed('/Exercise_list')
                  ...
                  Navigator.push(
                      context,
                      new MaterialPageRoute(
                          builder: (context) => new Exercise_list()));

//                  Navigator.pushReplacementNamed(context, "/Exercise_list");
                },
              ),
            ),
          ],
...
//                      border: Border.all(width: 1,color:Color(0xff70ff70)),
                ...
                child: Center(
                  child: Text(
                    'شاخص توده بدنی : 23',
                    style: TextStyle(fontSize: 18, fontFamily: 'Vazirnu'),
                  ),
                )),
          ],
        )),
...
//                        color: Color(0xffFD8D00),
                  ...
                  child: Text(
                    this.value,
                    style: TextStyle(fontFamily: 'Vazirnu', fontSize: 12),
                  )),
            ],
          )),
        ],
